...
function App() {
  ...
  const BASIC_SHADOW = 'shadow-lg';

  return (
    <div className="min-h-screen bg-gray-950"> 
      <nav className="pt-4 pb-4 select-none">
        <div className={`flex justify-center gap-16 text-gray-400 text-2xl`}>
          <a href="" target="" className={`flex text-center justify-center font-inter gap-2 items-center ${TEXT_HOVER_COLOR} transition delay-100 `}>
            Home
          </a>
          <a href="" target="" className={`flex text-center justify-center font-inter gap-2 items-center ${TEXT_HOVER_COLOR} transition delay-100`}>
            Artigos
      ...
      <div className="p-8 flex w-full">
        <div className="w-1/3 select-none">
          <img src={foto} className={`w-full h-full object-cover rounded-lg ${BASIC_SHADOW}`}></img> 
        </div>
        <div className="flex flex-col gap-4 w-full pl-8"> 
          <div className="flex justify-between gap-2">
            <div className="w-full bg-gray-900  p-4 rounded-lg ${BASIC_SHADOW} ">
              ...
              <p className={`font-inter ${TEXT_COLOR} select-none `}> 
                {currentText.text}
              </p>
            </div>

            <div className={`flex flex-col ${BASE_TEXT_CLASS} gap-2 select-none `}>
              <div className="flex gap-2 w-full">
                <p className={`text-6xl ${INACTIVE_BORDER} ${BASE_BORDER_CLASS} ${TEXT_HOVER_COLOR} ${BASIC_SHADOW} p-1`}>
                  Progress
                </p>
                <div className="flex flex-col items-start justify-center text-2xl gap-2 w-full">
                  <p className={`${INACTIVE_BORDER} ${BASE_BORDER_CLASS} ${TEXT_HOVER_COLOR} ${BASIC_SHADOW} w-full p-1`}>Next.js</p>
                  <p className={`${INACTIVE_BORDER} ${BASE_BORDER_CLASS} ${TEXT_HOVER_COLOR} ${BASIC_SHADOW} w-full p-1`}>Tailwind CSS</p>
                </div>
              </div>
              <div className="flex w-full gap-2">
                <div className="flex flex-col items-start justify-center text-2xl gap-2">
                  <p className={`${INACTIVE_BORDER} ${BASE_BORDER_CLASS} ${TEXT_HOVER_COLOR} ${BASIC_SHADOW} w-full p-1`}>Java</p>
                  <p className={`${INACTIVE_BORDER} ${BASE_BORDER_CLASS} ${TEXT_HOVER_COLOR} ${BASIC_SHADOW} w-full p-1`}>React</p>
                </div>
                <p className={`text-6xl ${INACTIVE_BORDER} ${BASE_BORDER_CLASS} ${TEXT_HOVER_COLOR} ${BASIC_SHADOW} p-1`}>Python</p>
                <div className="flex flex-col items-start justify-center text-2xl gap-2">
                  <p className={`${INACTIVE_BORDER} ${BASE_BORDER_CLASS} ${TEXT_HOVER_COLOR} ${BASIC_SHADOW} w-full p-1`}>FastAPI</p>
                  <p className={`${INACTIVE_BORDER} ${BASE_BORDER_CLASS} ${TEXT_HOVER_COLOR} ${BASIC_SHADOW} w-full p-1`}>PostgreSQL</p>
                </div>
              </div>
              <div className="flex gap-2 w-full ">
                <div className="flex flex-col items-start justify-center text-2xl gap-2 w-full">
                  <p className={`${INACTIVE_BORDER} ${BASE_BORDER_CLASS} ${TEXT_HOVER_COLOR} ${BASIC_SHADOW} w-full p-1`}>Typescript</p>
                  <p className={`${INACTIVE_BORDER} ${BASE_BORDER_CLASS} ${TEXT_HOVER_COLOR} ${BASIC_SHADOW} w-full p-1`}>Data Science</p>
                </div>
                <p className={`text-6xl ${INACTIVE_BORDER} ${BASE_BORDER_CLASS} ${TEXT_HOVER_COLOR} ${BASIC_SHADOW} p-1`}>Datasul</p>
              </div>
            </div>
          </div>
          ...
          <div className={`flex justify-center gap-16 ${TEXT_COLOR} text-2xl select-none`}>
            <a href="https://www.linkedin.com/in/alisson-sds/" target="_blank" 
               className={`flex text-center justify-center gap-2 items-center ${INACTIVE_BORDER} ${BASE_BORDER_CLASS} p-2 font-inter ${BASIC_SHADOW} ${TEXT_HOVER_COLOR} hover:${ACTIVE_COLOR}`}>
              <CiLinkedin />
              LinkedIn
            </a>
